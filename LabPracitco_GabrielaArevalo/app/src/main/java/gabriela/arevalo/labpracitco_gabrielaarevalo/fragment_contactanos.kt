package gabriela.arevalo.labpracitco_gabrielaarevalo
...
class fragment_contactanos : Fragment() {
    ...
    override fun onCreateView(
        ...
        val btnCorreoL = root.findViewById<Button>(R.id.btnCorreoL)

        btnCorreoL.setOnClickListener{
            Toast.makeText(context, "Mi correo es: 200190019@ricaldone.edu.sv", Toast.LENGTH_SHORT).show()
        }
        return root
